...
\begin{figure}[] 
	\begin{center}
		\includegraphics[width=0.5\textwidth]{Plots/Saved-Plots/Tweaking/}
  
 \end{center}
	\caption{massiv\_metall-stepCN.png}
	\label{Fig massiv_metall} % Som med ligningen, er dette navnet vi refererer til.
\end{figure}
